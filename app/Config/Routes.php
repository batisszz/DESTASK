...
$routes->get('/monitoring_performa/daftar_monitoring_performa', 'MonitoringPerforma::daftar_monitoring_performa'); //Akses beres tidak perlu diberi filter/middleware, hal ini karena semua orang bisa lihat daftar monitoring performa tergantung session yang login
...
$routes->get('/monitoring_performa/daftar_monitoring_performa', 'MonitoringPerforma::filter_monitoring_performa');
