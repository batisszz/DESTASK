    ...
    public array $filters = [
        ...
        'khususHOD' => [
            'before' => [
                ...
                '/kinerja/delete_kinerja_karyawan/*/*', '/monitoring_task/daftar_task_karyawan', '/monitoring_task/detail_task_karyawan/*', '/monitoring_task/filter', 'pekerjaan/detail_task_on_progress/*', 'pekerjaan/detail_task_overdue/*', 
                'pekerjaan/detail_task_ontarget/*','pekerjaan/detail_task_percepatan/*'. 'monitoring_performa/daftar_monitoring_performa', 'monitoring_performa/detail_monitoring_performa_produk/*',
            ],
        ],
        'khususHODandDireksi' => [
            'before' => [
